```
## 
Install vmmon and vmnet from cli


we can use the command below to make some configeration and install vmmone and vmnet
...
# SIMPLE SCRIPT THAT CAN AUTOMATE ALL THE INSTALLATION
```
#!/bin/bash
